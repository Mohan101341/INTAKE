...
function AfterOfferCnt() {
    return (
        <div className="after-offer-container">
            <section className="after-offer-section">
                ...
                <h3>1. Review and Accept Your Offer</h3>
                <p>
                ...
                <h3>3. Apply for Your Student Visa</h3>
                <p>
                ...
                <h3>4. Arrange Your Accommodation</h3>
                <p>
                ...
                <h3>5. Book Your Flights and Health Insurance</h3>
                <p>
                ...
                <h3>6. Attend a Pre-departure Briefing</h3>
                <p>
